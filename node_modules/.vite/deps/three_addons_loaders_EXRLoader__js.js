import { Bn as HalfFloatType, Br as LinearSRGBColorSpace, Ea as RGBAFormat, Ht as DataTextureLoader, Pr as LinearFilter, Ut as DataUtils, fo as RedFormat, oo as RGFormat, xn as FloatType } from "./three.module-CTISXuv4.js";
		...
		function lossyDctDecode(cscSet, rowPtrs, channelData, acBuffer, dcBuffer, outBuffer) {
			...
			for (let blocky = 0; blocky < numBlocksY; ++blocky) {
				...
				for (let blockx = 0; blockx < numBlocksX; ++blockx) {
					...
					if (numComp == 3) csc709Inverse(dctData);
