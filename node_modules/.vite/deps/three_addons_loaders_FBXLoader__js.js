import { $r as MathUtils, B as Bone, Bi as NumberKeyframeTrack, Bs as Vector3, Cs as Uint16BufferAttribute, Er as Line, Fo as Skeleton, Hs as VectorKeyframeTrack, J as BufferGeometry, Lo as SkinnedMesh, No as ShapeUtils, Nt as Curve, Or as LineBasicMaterial, Rn as Group, To as SRGBColorSpace, Ur as Loader, Vi as Object3D, Vs as Vector4, Wo as SpotLight, Wr as LoaderUtils, Zt as DirectionalLight, _a as Quaternion, _o as RepeatWrapping, at as ClampToEdgeWrapping, b as AnimationClip, bn as Float32BufferAttribute, ci as MeshLambertMaterial, di as MeshPhongMaterial, ds as TextureLoader, ii as Mesh, lt as ColorManagement, mn as Euler, na as PerspectiveCamera, ni as Matrix4, oa as PointLight, pa as PropertyBinding, st as Color, ti as Matrix3, us as Texture, v as AmbientLight, va as QuaternionKeyframeTrack, vn as FileLoader, zs as Vector2 } from "./three.module-CTISXuv4.js";
import { t as unzlibSync } from "./fflate.module-VQjam0ja.js";
...
var FBXTreeParser = class {
	...
	parseParameters(materialNode, textureMap, ID) {
		...
		if (parameters.opacity === 1 || parameters.opacity === 0) {
			...
			if (parameters.opacity === null) parameters.opacity = 1;
		}
	...
	parseScene(deformers, geometryMap, materialMap) {
		...
		if ("GlobalSettings" in fbxTree && "UpAxis" in fbxTree.GlobalSettings) {
			if (fbxTree.GlobalSettings.UpAxis.value === 2) {
		...
		if (lightAttribute === void 0) model = new Object3D();
			...
			switch (type) {
				...
				case 2:
					...
					} else if (lightAttribute.InnerAngle !== void 0) angle = MathUtils.degToRad(lightAttribute.InnerAngle.value);
...
var GeometryParser = class {
	...
	genFace(buffers, geoInfo, facePositionIndexes, materialIndex, faceNormals, faceColors, faceUVs, faceWeights, faceWeightIndices, faceLength) {
		...
		if (faceLength > 3) {
			...
			for (let i = 0; i < facePositionIndexes.length; i += 3) vertices.push(new Vector3(positions[facePositionIndexes[i]], positions[facePositionIndexes[i + 1]], positions[facePositionIndexes[i + 2]]));
	...
	addMorphTargets(parentGeo, parentGeoNode, morphTargets, preTransform) {
		...
		morphTargets.forEach(function(morphTarget) {
			morphTarget.rawTargets.forEach(function(rawTarget) {
				...
				if (morphGeoNode !== void 0) scope.genMorphGeometry(parentGeo, parentGeoNode, morphGeoNode, morphPreTransform, rawTarget.name);
			});
		});
	}
...
//# sourceMappingURL=three_addons_loaders_FBXLoader__js.js.map